        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="text-center lg:text-left">
            <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold text-gray-900 leading-tight mb-6">
              Taşınmanın <span className="text-primary">Güvenli</span> ve <span className="text-secondary">Keyifli</span> Yolu
            </h1>
            ...
            <p className="text-lg text-gray-600 mb-8 leading-relaxed">
              ...
              <strong className="text-primary"> İstanbul'un her ilçesinde</strong> ve <strong className="text-primary">Türkiye genelinde</strong> 7/24 hizmetinizdeyiz.
            </p>
          ...
          <div className="relative hidden lg:flex justify-center items-center">
            <div className="relative w-full h-96">
              ...
              <div className="relative z-10 flex flex-col gap-6 items-center justify-center h-full">
                <Truck size={120} className="text-primary drop-shadow-2xl" />
